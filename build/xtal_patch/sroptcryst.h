...
**/
	...
	{// E in eV; Length in m !!!
        ...
        //ARF03062019 change from: double bee = 1. / (1. + m_HXAi[1] / k0wXAi[1]);
        double bee = 1. / (1. + (m_HXAi_bee[1] * m_RXtLab[1][1] + m_HXAi_bee[2] * m_RXtLab[2][1]) / k0wXAi[1]); 
