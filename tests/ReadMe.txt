...
Some of this tests is examples of SRW original examples with turn off plotting and using wpg.srwlib instead original SRW srwlib. Prefix "slow_" applied for long running test.

Data for SRW tests is only links to the download SRW package used to build WPG.
